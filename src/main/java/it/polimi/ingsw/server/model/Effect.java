...
public class Effect {
    ...
    private static final int WHO_TO_DAMAGE_SEL_PLAYER = 0;
    private static final int STARTING_POINT_ME = 0;
    private static final int STARTING_POINT_LAST_DAMAGED = 1;
    private static final int STARTING_POINT_TEMP_SQUARE = 2;
    private static final int STARTING_POINT_TEMP_PLAYER = 3;
    private static final int DONT_CARE = -1;
    private static final int RECIPROCAL_POS_NOT_VISIBLE = 0;
    private static final int RECIPROCAL_POS_VISIBLE = 1;
    private static final int RECIPROCAL_POS_CARDINAL_DIR = 2;
    private static final int RECIPROCAL_POS_LINE_LAST_DAM = 3;
    private static final int DIVERSITY_ALREADY_DAM = 0;
    private static final int DIVERSITY_NOT_DAM_YET_PLAYERS = 1;
    private static final int DIVERSITY_NOT_DAM_YET_SQUARES = 2;
    private static final int DIVERSITY_NOT_MY_ROOM = 3;
    private static final int WHAT_NOTHING_TO_SEL_NO_LIMIT = -1;
    private static final int WHAT_SQUARE_NO_LIMIT = 0;
    private static final int WHAT_PLAYER_NO_LIMIT = 1;
    private static final int WHAT_NOTHING_TO_SEL_SOMEONE_ON_MY_SQUARE = 2;
    private static final int WHAT_SQUARE_SOMEONE_IN_ROOM = 3;
    private static final int WHAT_SQUARE_SOMEONE_ON_IT = 4;
    private static final int WHAT_NOTHING_SOMEONE_NEAR_ME = 5;
    private static final int SET_TEMP_SQUARE_DONT = -1;
    private static final int SET_TEMP_SQUARE_SEL_SQ = 0;
    private static final int SET_TEMP_SQUARE_SEL_PLAYERS_SQ = 1;
    private static final int SEL_TEMP_SQUARE_MY_SQ = 2;
    private static final int WHO_TO_MOVE_NOBODY = -1;
    private static final int WHO_TO_MOVE_ME = 0;
    private static final int WHO_TO_MOVE_SEL_PLAYER = 1;
    private static final int WHO_TO_MOVE_LAST_DAMAGED = 2;
    private static final int WHO_TO_MOVE_CHOSEN_PLAYER = 3;
    private static final int WHARE_TO_MOVE_NOWHERE = -1;
    private static final int WHERE_TO_MOVE_SEL_SQ = 0;
    private static final int WHERE_TO_MOVE_SEL_PLAYERS_SQ = 1;
    private static final int WHERE_TO_MOVE_TEMP_SQUARE = 2;
    private static final int WHERE_TO_MOVE_MY_SQUARE = 3;
    private static final int WHO_TO_DAMAGE_NOBODY = -1;
    private static final int WHO_TO_DAMAGE_ALL_IN_SEL_SQ = 1;
    private static final int WHO_TO_DAMAGE_ALL_IN_SEL_ROOM = 2;
    private static final int WHO_TO_DAMAGE_LAST_DAMAGED = 3;
    private static final int WHO_TO_DAMAGE_ALL_IN_MY_SQUARE = 4;
    private static final int WHO_TO_DAMAGE_ALL_IN_TEMP_SQ = 5;
    private static final int WHO_TO_DAMAGE_ALL_NEAR_ME = 6;
    private static final int WHO_TO_DAMAGE_ALL_TEMP_SQ_EXCPT_LAST_DAM = 7;
    private static final int WHO_TO_DAMAGE_SHOOTER = 8;
    private static final int SET_TEMP_PLAYER_DONT = -1;
    private static final int SET_TEMP_PLAYER_SEL_PLAYER = 0;
    private static final int SET_TEMP_PLAYER_ME = 1;
    /**
