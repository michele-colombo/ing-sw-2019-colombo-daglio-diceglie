...
public class PowerUpButton extends Parent{
    ...
    public PowerUpButton(PowerUpView powerUpView){
        ImageView powerUpImageView = new ImageView(BoardGui.getParser().getPowerUpButtonImage(powerUpView.getName() + FILE_IMAGE_SPACE + powerUpView.getColor().toString().toLowerCase()));
